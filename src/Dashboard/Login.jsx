    ...
    <div className="flex flex-col justify-center items-center gap-5 min-h-screen">
      ...
      <form className="flex flex-col justify-center gap-7" onSubmit={handleSubmit}>
        <div className="flex flex-col justify-center gap-2">
          ...
          <input className="border border-gray-500 p-2 rounder w-110" type="email" name="email" />
        </div>

        <div className="flex flex-col justify-center gap-2">
          <label className="text-gray-600 font-medium">Password</label>
          <input className="border border-gray-500 p-2 rounder w-110" type="password" name="password" />
